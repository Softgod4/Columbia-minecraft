...
export default function Market() {
  ...
  const products = [ 
      { name: 'CLS Проходка', price: 99.00, desc: 'Это основной сервер, куда можно войти с лицензией, и пиратки. На данном сервере игроки могут создавать свои города, торговать, и участвовать в ивентах самого сервера так и в ивентах самих игроков, и многое другое.'},
